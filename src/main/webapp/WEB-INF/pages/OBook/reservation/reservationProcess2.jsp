...
//                            + "\n Current Date : " + reservationDate
//                            + "\n Reserved Time : "+attendenceTime
//                            + "\n Working Day ID : "+workingTimeId
//                        );
                    ///////////////////////////////////////////////////////////////
                    // Getting Ajax
                    var b;
...
<!--                                        <div class="price-circle"> 
                                             <p class="price-value">29<sup>.00</sup>LE</p>
                                                 <span >per month</span>
<%--     <img src="<c:url value='/resources/images/right-sign.png'/>" alt="Smiley face" height="42" width="42">             --%>
                                        </div>   -->
                                     <div class="col-md-3">
                                         <div class="circle c2 img-circle">
<!--                                             <h4 class="yellow">Cost</h4>-->
<!--                                             <span class="icon yellow">
                                                 <i class="fa fa-eur"></i>
                                             </span>-->
                                             <div class="cost-area"> 
                                                 <span class="price-large yellow">124,</span> 
                                                 <span class="price-small">90</span>
                                             </div>
<!--                                             <p>Great for small Business</p>-->
                                             <button type="button" class="btn btn-warning paid-button">Paid</button>
                                         </div>
                                     </div>
