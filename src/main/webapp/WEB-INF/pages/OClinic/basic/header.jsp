            ...
            <div class="nav_menu" style="position: fixed;top: 0;width: 100%;z-index: 100;">
                ...
                <nav class="" role="navigation">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="<c:url value='/resources/images/khaled.jpg'/>" alt="">Khaled Mosaad
                    ...
                    <ul class="navbar-left">
                        <input type="text" id="patientSearch" name="Search" class="searchBox" placeholder="Search For Patient" id="search" required />
                    </ul>              
                </nav>
            </div>
        </div>
