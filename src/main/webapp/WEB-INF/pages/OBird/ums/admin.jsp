            ...
            $(document).ready(function() {
              /// SET the Icon of the Keyboard   
                ...
                $(".container").on("click","#RegisterAdmin", function(e) { 
                    ...
                    var profileURL = "/ocare/ums/admin/data/"+0;
                    // getting visit
                    var request = $.ajax({
                        url: profileURL,
                        type: "GET",
                ...
                $(".container").on("click",".profiles", function(e) { 
                    ...
                    var userId=$(this).parents("tr").find('input[type="hidden"][name="userId"]').val();
                     // URL for insurrance Profile
                    var profileURL = "/ocare/ums/admin/data/"+userId;
                    // getting visit
                    var request = $.ajax({
                        url: profileURL,
                        type: "GET",
                ...
                $(".container").on("click",".enableUser", function(e) {
                    ...
                    var request = $.ajax({
                            url: "/ocare/ums/admin/activeOrDeactive",
                            type: "POST",
                            dataType: 'json',
                        data: {  
                                adminId:adminId,
                                ...
                                <div class="panel-heading">
                                   List Of Admins
                                    ...
                                    <div class="panel-body">
                                           <center>
                                                <input type="text" id="searchForAdmin" name="Search" class="listSearchBar keyboardInput" placeholder="Filter Admins"  required />    
                                            </center>
